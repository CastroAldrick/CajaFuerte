...
//****// Scan Card
      ...
      if ((cardScanningTimer > 0) || (successfulRead == 1)){
        ...
        if (successfulRead == 1){
          ...
          for (int num = 0; num <= 4; num++){
            Serial.print(enteredCard); Serial.print(" = "); Serial.println(sCards[num]);;
    ...
    case 5:
      ...
      case 7: //  Add Card
        ...
        for (int card = 0; card <= 4; card++){
          if (sCards[card] == " EMPTY EMPTY EMPTY "){
            Serial.println(card);
            emptySlot[card] = true;
            emptySpace++;
      ...
      case 8:
        ...
        for (int card = 0; card <= 4; card++){
          if (sCards[card] != " EMPTY EMPTY EMPTY "){
            Serial.print(card);
            Serial.println(" Card is not empty");
